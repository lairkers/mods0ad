...
function* GenerateMap(mapSettings)
{
	...
	const oTower = mapSettings.Size >= 256 && getDifficulty() >= 3 ? "structures/kush/defense_tower" : "structures/kush/sentry_tower";
	...
	const oWallMedium = "structures/cart/wall_short";
	const oWallGate = "structures/cart/wall_gate";
	const oWallTower = "structures/cart/wall_tower";
	...
	if (placeNapataWall)
	{
		...
		for (let woffset = 0; woffset <= 4; woffset += 2) {                                                                           /* Changed here for more side and back walls */
			const wallGridMaxAngleBack = gridMaxAngle + wallGridMaxAngleSummand + woffset / 50;
			const wallGridPositionFront = distributePointsOnCircularSegment(gridPointsX, wallGridMaxAngleBack, wallGridStartAngle - woffset / 100, wallGridRadiusFront, gridCenter)[0];
			const wallGridPositionBack = distributePointsOnCircularSegment(gridPointsX, wallGridMaxAngleBack, wallGridStartAngle - woffset / 100, wallGridRadiusBack, gridCenter)[0];
