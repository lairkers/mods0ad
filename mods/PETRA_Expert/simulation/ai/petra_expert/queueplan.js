...
PETRA_EXPERT.QueuePlan = function(gameState, type, metadata)
{
	...
	if (!this.template)
	{
		API3.warn("Tried to add the inexisting template " + this.type + " to Petra Expert.");
		return false;
	}
...
PETRA_EXPERT.QueuePlan.prototype.isInvalid = function(gameState)
{
	return false;
};

/** if true, the queue manager will begin increasing this plan's account. */
PETRA_EXPERT.QueuePlan.prototype.isGo = function(gameState)
{
	return true;
};

/** can we start this plan immediately? */
PETRA_EXPERT.QueuePlan.prototype.canStart = function(gameState)
{
	return false;
};

/** process the plan. */
PETRA_EXPERT.QueuePlan.prototype.start = function(gameState)
{
	// should call onStart.
};

PETRA_EXPERT.QueuePlan.prototype.getCost = function()
{
 ...
 */
PETRA_EXPERT.QueuePlan.prototype.onStart = function(gameState)
{
};
