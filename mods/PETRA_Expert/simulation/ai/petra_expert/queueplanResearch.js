PETRA_EXPERT.ResearchPlan = function(gameState, type, rush = false)
{
	if (!PETRA_EXPERT.QueuePlan.call(this, gameState, type, {}))
		return false;
...
PETRA_EXPERT.ResearchPlan.prototype = Object.create(PETRA_EXPERT.QueuePlan.prototype);

PETRA_EXPERT.ResearchPlan.prototype.canStart = function(gameState)
{
...
PETRA_EXPERT.ResearchPlan.prototype.getBestResearchers = function(gameState, noRequirementCheck = false)
{
...
PETRA_EXPERT.ResearchPlan.prototype.isInvalid = function(gameState)
{
	return gameState.isResearched(this.type) || gameState.isResearching(this.type);
};

PETRA_EXPERT.ResearchPlan.prototype.start = function(gameState)
{
...
PETRA_EXPERT.ResearchPlan.prototype.onStart = function(gameState)
{
...
PETRA_EXPERT.ResearchPlan.prototype.Serialize = function()
{
	return {
...
PETRA_EXPERT.ResearchPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
