PETRA_EXPERT.launchAttackMessages = {
	"hugeAttack": [
...
PETRA_EXPERT.answerRequestAttackMessages = {
	"join": [
...
PETRA_EXPERT.sentTributeMessages = [
...
PETRA_EXPERT.requestTributeMessages = [
...
PETRA_EXPERT.newTradeRouteMessages = [
...
PETRA_EXPERT.newDiplomacyMessages = {
	"ally": [
...
PETRA_EXPERT.answerDiplomacyRequestMessages = {
	"ally": {
		"decline": [
...
PETRA_EXPERT.sendDiplomacyRequestMessages = {
	"ally": {
		"sendRequest": [
...
PETRA_EXPERT.emergencyMessages = {
	"enter": [
...
PETRA_EXPERT.chatLaunchAttack = function(gameState, player, type)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/allies " + pickRandom(this.launchAttackMessages[type === PETRA_EXPERT.AttackPlan.TYPE_HUGE_ATTACK ? "hugeAttack" : "other"]),
...
PETRA_EXPERT.chatAnswerRequestAttack = function(gameState, player, answer, other)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
PETRA_EXPERT.chatSentTribute = function(gameState, player)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
PETRA_EXPERT.chatRequestTribute = function(gameState, resource)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
PETRA_EXPERT.chatNewTradeRoute = function(gameState, player)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
PETRA_EXPERT.chatNewPhase = function(gameState, phase, status)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
PETRA_EXPERT.chatNewDiplomacy = function(gameState, player, newDiplomaticStance)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
PETRA_EXPERT.chatAnswerRequestDiplomacy = function(gameState, player, requestType, response, requiredTribute)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
PETRA_EXPERT.chatNewRequestDiplomacy = function(gameState, player, requestType, status)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/msg " + gameState.sharedScript.playersData[player].name + " " +
...
PETRA_EXPERT.chatEmergency = function(gameState, enable)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
